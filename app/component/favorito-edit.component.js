...
var FavoritoEditComponent = (function () {
    ...
    FavoritoEditComponent.prototype.getFavorito = function () {
        ...
        this._route.params.forEach(function (params) {
            var id = params["id"];
            _this._favoritoService.getFavorito(id).subscribe(function (res) {
                _this.favorito = res.favoritos;
                if (!_this.favorito) {
    ...
    FavoritoEditComponent.prototype.onSubmit = function () {
        ...
        this._route.params.forEach(function (params) {
            var id = params["id"];
            _this._favoritoService.editFavorito(id, _this.favorito).subscribe(function (res) {
                if (!_this.favorito) {
